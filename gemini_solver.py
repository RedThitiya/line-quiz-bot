...
- ถ้าอ่านคำถามในรูปไม่ออกหรือไม่มั่นใจในคำตอบ ให้ตอบว่า
  "ขออภัยค่ะ อ่านคำถามในรูปไม่ชัดเจน รบกวนส่งรูปที่ชัดขึ้นอีกครั้งนะคะ"
...
def solve_question_image(image_bytes: bytes) -> str:
    ...
    try:
        ...
        return answer if answer else "ขออภัยค่ะ ไม่สามารถประมวลผลคำถามในรูปนี้ได้ รบกวนลองส่งใหม่อีกครั้งนะคะ"
    except Exception as e:
        log.error(f"Gemini solve error: {e}")
        return "ขออภัยค่ะ เกิดข้อผิดพลาดระหว่างอ่านรูปภาพ รบกวนลองส่งใหม่อีกครั้งนะคะ"
